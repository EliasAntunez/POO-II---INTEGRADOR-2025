...
-- =============================================================================
INSERT INTO cliente (id, dni, nombre, apellido, razon_social, cuit, email, telefono, direccion, condicion_fiscal, estado, activo, saldo_cuenta_corriente, condicion_pago) VALUES 
(1, '10111111', 'Juan', 'Perez', 'Perez Sistemas SA', '30101111115', 'juan@perez.com', '11111111', 'Calle 1', 'RESPONSABLE_INSCRIPTO', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(2, '10222222', 'Maria', 'Lopez', 'Lopez Constructora SRL', '30102222225', 'maria@lopez.com', '22222222', 'Calle 2', 'RESPONSABLE_INSCRIPTO', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(3, '10333333', 'Carlos', 'Diaz', 'Diaz Logistica SA', '30103333335', 'carlos@diaz.com', '33333333', 'Calle 3', 'RESPONSABLE_INSCRIPTO', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(4, '10444444', 'Ana', 'Sosa', 'Sosa Agropecuaria', '30104444445', 'ana@sosa.com', '44444444', 'Calle 4', 'RESPONSABLE_INSCRIPTO', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(5, '10555555', 'Luis', 'Mora', 'Mora Tech Solutions', '30105555555', 'luis@mora.com', '55555555', 'Calle 5', 'RESPONSABLE_INSCRIPTO', 'SUSPENDIDO', false, 0.00, 'CUENTA_CORRIENTE_30'),
(6, '20111111', 'Pedro', 'Gomez', 'Pedro Gomez Plomeria', '27201111115', 'pedro@gomez.com', '66666666', 'Av A 100', 'MONOTRIBUTISTA', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(7, '20222222', 'Sofia', 'Ruiz', 'Sofia Ruiz Diseño', '27202222225', 'sofia@ruiz.com', '77777777', 'Av B 200', 'MONOTRIBUTISTA', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(8, '20333333', 'Miguel', 'Torres', 'Torres Fletes', '20203333335', 'miguel@torres.com', '88888888', 'Av C 300', 'MONOTRIBUTISTA', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(9, '20444444', 'Laura', 'Vargas', 'Vargas Catering', '27204444445', 'laura@vargas.com', '99999999', 'Av D 400', 'MONOTRIBUTISTA', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(10, '20555555', 'Diego', 'Castro', 'Diego Castro Electricidad', '20205555555', 'diego@castro.com', '10101010', 'Av E 500', 'MONOTRIBUTISTA', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(11, '30111111', 'Roberto', 'Sanchez', 'Roberto Sanchez', '20301111115', 'roberto@gmail.com', '12121212', 'Barrio Norte 1', 'NO_RESPONSABLE', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(12, '30222222', 'Lucia', 'Mendez', 'Lucia Mendez', '27302222225', 'lucia@hotmail.com', '13131313', 'Barrio Norte 2', 'NO_RESPONSABLE', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(13, '30333333', 'Jorge', 'Fernandez', 'Jorge Fernandez', '20303333335', 'jorge@yahoo.com', '14141414', 'Barrio Norte 3', 'NO_RESPONSABLE', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(14, '40111111', 'Fundacion', 'Ayuda', 'Fundacion Ayuda ONG', '30401111115', 'admin@ong.org', '15151515', 'Centro 1', 'EXENTO', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30'),
(15, '40222222', 'Club', 'Social', 'Club Social Deportivo', '30402222225', 'info@club.com', '16161616', 'Centro 2', 'EXENTO', 'ACTIVO', true, 0.00, 'CUENTA_CORRIENTE_30');

-- =============================================================================
-- 4. ASIGNACIONES (20 Registros)
-- =============================================================================
INSERT INTO cliente_servicio (id_cliente, id_servicio, fecha_asignacion, activo, precio) VALUES 
(1, 4, '2024-01-01', true, 80000.00), (1, 12, '2024-01-01', true, 6000.00),
(2, 3, '2024-02-01', true, 35000.00), (3, 2, '2024-02-10', true, 22000.00), (3, 13, '2024-02-10', true, 7500.00),
(4, 12, '2024-03-01', true, 6000.00), (5, 9, '2024-01-01', true, 60000.00),
(6, 1, '2024-01-15', true, 15000.00), (7, 2, '2024-04-01', true, 22000.00), (8, 1, '2024-05-01', true, 15000.00),
(9, 1, '2024-06-01', true, 15000.00), (10, 1, '2024-07-01', true, 15000.00),
(11, 1, '2024-01-01', true, 15000.00), (12, 2, '2024-01-01', true, 22000.00), (13, 1, '2024-01-01', true, 15000.00),
(14, 14, '2024-01-01', true, 20000.00), (15, 6, '2024-01-01', true, 14500.00),
(1, 11, '2024-01-01', false, 25000.00), (2, 5, '2024-01-01', false, 8500.00), (6, 5, '2024-01-01', false, 8500.00);
...
INSERT INTO factura (id, cliente_id, fecha_emision, fecha_vencimiento, total, monto_pagado, estado, anulada, tipo_comprobante, fecha_inicio_periodo, fecha_fin_periodo) 
VALUES (1, 1, '2024-10-01 10:00:00', '2024-10-11', 101600.00, 101600.00, 'PAGADA', false, 'FACTURA_A', '2024-09-01', '2024-09-30');
...
INSERT INTO factura (id, cliente_id, fecha_emision, fecha_vencimiento, total, monto_pagado, estado, anulada, tipo_comprobante, fecha_inicio_periodo, fecha_fin_periodo) 
VALUES (2, 2, '2024-10-01 10:05:00', '2024-10-11', 42350.00, 20000.00, 'PARCIALMENTE_PAGADA', false, 'FACTURA_A', '2024-09-01', '2024-09-30');
